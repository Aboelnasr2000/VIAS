...
public final class InfoBottomSheetBinding implements ViewBinding {
  ...
  @NonNull
  public final AppCompatImageButton DthreadsMinus;

  @NonNull
  public final AppCompatImageButton DthreadsPlus;

  @NonNull
  public final TextView DthreadsValue;
  ...
  private InfoBottomSheetBinding(@NonNull NestedScrollView rootView,
      @NonNull AppCompatImageButton DthreadsMinus, @NonNull AppCompatImageButton DthreadsPlus,
      @NonNull TextView DthreadsValue, @NonNull NestedScrollView bottomSheetLayout,
    ...
    this.DthreadsMinus = DthreadsMinus;
    this.DthreadsPlus = DthreadsPlus;
    this.DthreadsValue = DthreadsValue;
  ...
  public static InfoBottomSheetBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.Dthreads_minus;
      AppCompatImageButton DthreadsMinus = ViewBindings.findChildViewById(rootView, id);
      if (DthreadsMinus == null) {
        break missingId;
      }

      id = R.id.Dthreads_plus;
      AppCompatImageButton DthreadsPlus = ViewBindings.findChildViewById(rootView, id);
      if (DthreadsPlus == null) {
        break missingId;
      }

      id = R.id.Dthreads_value;
      TextView DthreadsValue = ViewBindings.findChildViewById(rootView, id);
      if (DthreadsValue == null) {
        break missingId;
      }
      ...
      return new InfoBottomSheetBinding((NestedScrollView) rootView, DthreadsMinus, DthreadsPlus,
          DthreadsValue, bottomSheetLayout, inferenceTimeLabel, inferenceTimeVal, maxResultsMinus,
